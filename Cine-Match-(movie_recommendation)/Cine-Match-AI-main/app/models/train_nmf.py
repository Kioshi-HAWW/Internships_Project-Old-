...
def train_nmf_model(data_dir: Path, output_dir: Path = DEFAULT_OUTPUT_DIR) -> Path:
    ...
    model_path = output_dir / "nmf.pkl"
    joblib.dump(algo, model_path)
    return model_path


def main() -> None:
    parser = argparse.ArgumentParser(description="Train the NMF collaborative filtering model.")
    ...
    model_path = train_nmf_model(args.data_dir, args.output_dir)
